$(document).ready(function () {
  for (i = 0; i < 10; i++) {
    ...
    '<div class="col-3 ">' +
    '<img class="cap-border" src="./images/cap.png" alt="">' +
    "</div>" +
    '<div class="col-9">' +
    "John wick <br>" +
    "<span>";
    ...
    for(let i=0;i<rating;i++){
        temp_middle_cell2 = temp_middle_cell2 + '<img src="./images/star1.png" alt="">';
    }
    for(let i=0;i<5-rating;i++){
        temp_middle_cell2 = temp_middle_cell2 + '<img src="./images/star2.png" alt="">';
    }
